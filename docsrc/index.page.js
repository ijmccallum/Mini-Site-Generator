...
module.exports = function(){
    return html`
        ...
        <body class="text-center">
            ...
            <section class="screen-height center-section bg-white">
                <p class="no-wrap">
    ...
    &#96;
            ...
            <section class="center-section">
                <div class="md-flex-row">
                    ...
                    <div class="padding-30">
                        <a href="https://app.netlify.com/start/deploy?repository=https://github.com/ijmccallum/msg-starter">
                            <img src="https://www.netlify.com/img/deploy/button.svg" title="Deploy to Netlify" width="146" height="32">
                        </a>
                    </div>
                    <div class="padding-30">
